<template>
  <div id="updateShipping" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <validation-observer v-slot="{ invalid }" ref="formshippingupdate">
        <form method="POST" class="modal-content" autocomplete="off" @submit.prevent="updateShippingSubmit(shipping)">
          ...
          <div class="modal-footer">
            <button type="reset" class="btn btn-secondary btn-icon-split" data-dismiss="modal" @click.prevent="updateShippingReset()">
...
export default {
  ...
  methods: {
    updateShippingSubmit: function (shipping) {
      var data = {
        user_id: this.userid,
      ...
      this.$refs.formshippingupdate.validate().then(success => {
        if (!success) {
          return
        }
    ...
    updateShippingReset: function () {
      ...
      this.$refs.formshippingupdate.reset()
    }
  }
}
