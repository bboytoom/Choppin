                ...
                <div class="form-group">
                    ...
                    <validation-provider name="Nombre" rules="min:3|max:40|required" v-slot="{ errors, classes }">
                        <div class="control" :class="classes">
                            <input type="text" class="form-control" placeholder="Ingresa tu nombre" v-model="user.name" maxlength="41">
                            <span>
                                {{ errors[0] }}
                            </span>
                        </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <validation-provider name="Apellido paterno" rules="min:4|max:30|required" v-slot="{ errors, classes }">
                        <div class="control" :class="classes">
                            <input type="text" class="form-control" placeholder="Ingresa tu apellido" v-model="user.father_surname" maxlength="31">
                            <span>
                                {{ errors[0] }}
                            </span>
                        </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <validation-provider name="Apellido materno" rules="min:4|max:30" v-slot="{ errors, classes }">
                        <div class="control" :class="classes">
                            <input type="text" class="form-control" placeholder="Ingresa tu apellido" v-model="user.mother_surname" maxlength="31">
                            <span>
                                {{ errors[0] }}
                            </span>
                        </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <validation-provider name="Correo electronico" rules="min:8|max:80|required|email" v-slot="{ errors, classes }">
                        <div class="control" :class="classes">
                            <input type="email" class="form-control" placeholder="Ingresa tu correo electronico" v-model="user.email" maxlength="81">
                            <span>
                                {{ errors[0] }}
                            </span>
                        </div>
