...
import photoSlideTabla from './components/PhotoSlide/PhotoSlideTabla.vue'
import photoSlideStore from './components/PhotoSlide/PhotoSlideStore.vue'
import photoSlideupdate from './components/PhotoSlide/PhotoSlideupdate.vue'
...
export default {
  ...
  methods: {
    index: function (page) {
      this.$http.get('/photoslide/all/' + this.slideid + '?page=' + page).then((response) => {
