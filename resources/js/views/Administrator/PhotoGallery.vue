...
import tablePhotoGallery from './components/PhotoGallery/PhotoGalleryTable.vue'
import updatePhotoGallery from './components/PhotoGallery/PhotoGalleryUpdate.vue'
import storePhotoGallery from './components/PhotoGallery/PhotoGalleryStore.vue'
...
export default {
  ...
  methods: {
    index: function (page) {
      this.$http.get('/photosgalleries/all/' + this.galleryid + '?page=' + page).then((response) => {
