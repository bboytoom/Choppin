...
import tableConfiguration from './components/Configurations/ConfigurationsTable.vue'
import storeConfiguration from './components/Configurations/ConfigurationsStore.vue'
import updateConfiguration from './components/Configurations/ConfigurationsUpdate.vue'
import imageConfiguration from './components/Configurations/ConfigurationsImage.vue'
...
export default {
  ...
  methods: {
    index: function (page) {
      this.$http.get('/configurations?page=' + page).then((response) => {
