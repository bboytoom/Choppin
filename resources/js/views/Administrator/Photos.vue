...
import tablePhoto from './components/Photos/PhotosTable.vue'
import updatePhoto from './components/Photos/PhotosUpdate.vue'
import storePhoto from './components/Photos/PhotosStore.vue'
